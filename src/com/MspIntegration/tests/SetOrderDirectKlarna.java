...
public class SetOrderDirectKlarna {
	...
	public static void main(String[] args) {
		...
		order.setDirectKlarna(Long.toString(date.getTime()),
				"Product description", 24200, "EUR", new PaymentOptions(
						"http://example.com/notify",
						"http://example.com/success",
						"http://example.com/failed"), GatewayInfo.Klarna(
						"1980-01-30", "male", "+31 (0)20 8500 500",
						"test@multisafepay.com"), new ShoppingCart(items),
				checkout_options, customer, delivery);
