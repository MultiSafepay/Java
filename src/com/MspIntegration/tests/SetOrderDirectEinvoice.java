...
public class SetOrderDirectEinvoice {
	...
	public static void main(String[] args) {
		...
		order.setDirectEinvoice(Long.toString(date.getTime()),
				"Product description", 24200, "EUR", new PaymentOptions(
						"http://example.com/notify",
						"http://example.com/success",
						"http://example.com/failed"), GatewayInfo.Einvoice(
						"1980-01-30", "NL39 RABO 0300 0652 64",
						"+31 (0)20 8500 500", "test@multisafepay.com",
						"referrer", "user-agent"), new ShoppingCart(items),
