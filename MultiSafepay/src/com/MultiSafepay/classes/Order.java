...
public class Order {
	...
	public Order setDirectPayAfter(String order_id,String description,Integer amount,String currency,PaymentOptions payment_options,GatewayInfo gateway_info,ShoppingCart shopping_cart,CheckoutOptions checkout_options)
	{
		this.type 				= "direct";
